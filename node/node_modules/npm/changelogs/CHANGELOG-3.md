...
for their terminals.  Windows doesn't provider* any facility available to
Node.js for determining the current code page, so we no longer try to use
Unicode on Windows.

_\* The facilities it does provider are a command line tool and a windows
...
* [`7537fe1`](https://github.com/npm/npm/commit/7537fe1748c27e6f1144b279b256cd3376d5c41c)
  ...
  strictly equal to what, say, parsed JSON would provider.
  ([@domenic](https://github.com/domenic))
...
* [`39dea9c`](https://github.com/npm/npm/commit/39dea9ca4216c6ea628f5ca47d2b34a4b251a1ed)
  ...
  submodules. It also doesn't provider a means to disable automatic
...
like to give you a suite of stand alone modules that provider
...
* [`b31812e`](https://github.com/npm/npm/commit/b31812e)
  ...
  when you have two modules that try to provider the same bin.
  ([@iarna](https://github.com/iarna))
