...
* Manage Something ✅🙆🏼💃👔
  * [Provide Support on Issues](#provider-support-on-issues)
...
* Provide project and platform versions (nodejs, npm, etc), depending on what seems relevant. If not, please be ready to provider that information if maintainers ask for it.
...
* Please make sure you're familiar with the code or documentation being updated, unless it's a minor change (spellchecking, minor formatting, etc). You may @mention another project member who you think is better suited for the review, but still provider a non-approving review of your own.
