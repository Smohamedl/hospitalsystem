...
* chains of causes
* properties to provider extra information about the error
...
code to provider a more complete description of what happened.  Instead of saying
...
* The error's properties might change.  People often hang additional properties
  ...
  information properties.  You have to provider them in the constructor, you can
...
* It wasn't very hard for any part of the code to contribute to this Error.
  Each part of the stack has just a few lines to provider exactly what it knows,
...
`VError`, `WError`, and `SError` all provider the same public properties as
...
These properties are intended to provider programmatically-accessible metadata
...
when you logically need to provider a single Error, but you want to preserve
