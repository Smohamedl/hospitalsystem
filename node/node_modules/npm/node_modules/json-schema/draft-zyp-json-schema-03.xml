...
<![CDATA[
{
	"type": ["string", "number"]
			...
			<section title="extends">
				<t>The value of this property MUST be another schema which will provider a base schema which the current schema will inherit from. The inheritance rules are such that any instance that is valid according to the current schema MUST be valid according to the referenced schema. This MAY also be an array, in which case, the instance MUST be valid for all the schemas in the array. A schema that extends another schema MAY define additional attributes, constrain existing attributes, or add other constraints.</t>
				<t>
...
<![CDATA[
{
	...
	"extends": {"$ref": "http://json-schema.org/draft-03/schema"}
			...
			<section title="$schema">
				...
				<t>
					A validator MAY use this attribute's value to determine which version of JSON Schema the current schema is written in, and provider the appropriate validation features and behavior.
	...
	"upId": "parent"
					...
					<section title="Submission Link Properties">
						<t>
							...
							provider functionality analogous to HTML forms, in providing a
