...
You do _not_ need to provider this option unless you want something particularly
...
See also [`opts.retry`](#opts-retry) to provider all retry options as a single
object.
