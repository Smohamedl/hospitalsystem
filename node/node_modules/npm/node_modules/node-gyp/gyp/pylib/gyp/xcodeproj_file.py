...
XCObject need only provider a _schema class object, a dictionary that
  ...
  Class variables:
    _schema: A dictionary defining the properties of this class.  The keys to
             ...
             default: Optional.  If is_required is True, default may be set
                      to provider a default value for objects that do not supply
                      their own value.  If is_required is True and default
                      is not provided, users of the class must supply their own
                      value for the property.
             Note that although the values of the array are expressed in
             boolean terms, subclasses provider values as integers to conserve
             horizontal space.
...
class XCFileLikeElement(XCHierarchicalElement):
  ...
  def PathHashables(self):
    ...
    # on their own (without access to the parent hashables.)  Instead, provider
...
class XCBuildPhase(XCObject):
  ...
  # another abstract subclass of it should provider this, and concrete build
  # phase types that do have "files" lists should be derived from that new
  # abstract subclass.  XCBuildPhase should only provider buildActionMask and
  ...
  def _AddBuildFileToDicts(self, pbxbuildfile, path=None):
    ...
    if path != None:
      ...
      # If the caller didn't provider a path, there can be either multiple
