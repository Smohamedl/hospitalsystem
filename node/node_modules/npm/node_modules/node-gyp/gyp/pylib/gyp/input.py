...
# pathnames.  The generators can provider more keys, the two lists are merged
...
def GetIncludedBuildFiles(build_file_path, aux_data, included=None):
  ...
  file.  Those keys provider access to dicts whose "included" keys contain
...
# a build file that contains targets and is expected to provider a targets dict
...
def BuildTargetsDict(data):
  ...
  in the returned dict.  These keys provider access to the target dicts,
...
def ExpandWildcardDependencies(targets, data):
  ...
  Any target that does not wish to be included by wildcard can provider an
