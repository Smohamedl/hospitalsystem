...
.RE
.P
You can specify either one or both values\. If you want to provider only a url,
...
.P
You can also provider a \fB\|\.npmignore\fP file in the root of your package or
...
.SS Local Paths
.P
As of version 2\.0\.0 you can provider a path to a local directory that contains a
