...
export class MedicalServiceService {
  ...
  public resourceSearchUrl = SERVER_API_URL + 'api/_search/medical-services';
  ...
  search(req?: any): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<IMedicalService[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
  }
}
