...
export class ProviderComponent implements OnInit, OnDestroy {
  ...
  constructor(
    protected providedrService: ProviderService,
  ...
  transition() {
    this.router.navigate(['/providedr'], {
      queryParams: {
        page: this.page,
        size: this.itemsPerPage,
  ...
  ngOnInit() {
    this.loadAll();
    this.registerChangeInProvidedrs();
  }
  ...
  registerChangeInProvidedrs() {
    this.eventSubscriber = this.eventManager.subscribe('providedrListModification', () => this.loadAll());
  }
