...
import { SocialOrganizationComponent } from 'app/entities/social-organization/social-organization.component';
  ...
  describe('SocialOrganization Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new SocialOrganization(123)],
            headers
          })
        )
      );
      ...
      expect(comp.socialOrganizations[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
