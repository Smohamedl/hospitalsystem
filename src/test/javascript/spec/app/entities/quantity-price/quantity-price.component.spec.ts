...
import { QuantityPriceComponent } from 'app/entities/quantity-price/quantity-price.component';
...
describe('Component Tests', () => {
  describe('QuantityPrice Management Component', () => {
    let comp: QuantityPriceComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [QuantityPriceComponent],
        providers: [
          {
        ...
        .overrideTemplate(QuantityPriceComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.quantityPrices[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
