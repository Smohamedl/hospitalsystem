...
describe('Service Tests', () => {
  describe('GuardSchedule Service', () => {
    let injector: TestBed;
    let service: GuardScheduleService;
    let httpMock: HttpTestingController;
    let elemDefault: IGuardSchedule;
    let expectedResult;
    beforeEach(() => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a GuardSchedule', () => {
      ...
      it('should delete a GuardSchedule', () => {
