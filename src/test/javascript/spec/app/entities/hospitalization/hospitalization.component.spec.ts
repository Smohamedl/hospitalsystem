...
import { HospitalizationComponent } from 'app/entities/hospitalization/hospitalization.component';
...
describe('Component Tests', () => {
  describe('Hospitalization Management Component', () => {
    let comp: HospitalizationComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(HospitalizationComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.hospitalizations[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
