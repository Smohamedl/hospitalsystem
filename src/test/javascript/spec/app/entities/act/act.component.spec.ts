...
import { ActComponent } from 'app/entities/act/act.component';
import { ActService } from 'app/entities/act/act.service';
import { Act } from 'app/shared/model/act.model';

describe('Component Tests', () => {
  describe('Act Management Component', () => {
    let comp: ActComponent;
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.acts[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
