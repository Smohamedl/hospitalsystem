...
export class ActComponent implements OnInit, OnDestroy {
  ...
  trackId(index: number, item: IAct) {
    return item.id;
  }

  registerChangeInActs() {
    this.eventSubscriber = this.eventManager.subscribe('actListModification', () => this.loadAll());
  }
  ...
  protected paginateActs(data: IAct[], headers: HttpHeaders) {
